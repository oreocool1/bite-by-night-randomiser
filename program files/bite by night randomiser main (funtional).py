...
def loadKiller():
       ...
       count = 0
       with open (killerdata) as playerDataFile:
              playerData = playerDataFile.read()
              print ("--killer Data Loaded--")
              print(playerData)
              time.sleep(1.5)
       playerDataFile = open(killerdata)
...
print ('''
       ...
       🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪
       🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪
       🟪 Welcome to Bite by night randomiser V5 🟪
       🟪🟪🟪🟪🟪🟪🟪 this is a wip  🟪🟪🟪🟪🟪🟪🟪
       🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪
       🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪🟪
       ''')
...
if os.path.exists(killerdata):
       ...
       time.sleep(2)
       with open(killerdata, "x") as playerDataFile:
              ()
       playerDataFile = open(killerdata , "w")
